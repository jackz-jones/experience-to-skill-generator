...
show_usage() {
    ...
    echo ""
    echo "为非 OpenClaw agent 生成工作流指引（让 agent 自动学会完整流程）:"
    echo "  experience-to-skill-generator setup-agent claude-code   # 生成 CLAUDE.md"
    echo "  experience-to-skill-generator setup-agent cursor         # 生成 .cursorrules"
    echo "  experience-to-skill-generator setup-agent windsurf       # 生成 .windsurfrules"
    echo ""
    echo "常用环境变量:"
