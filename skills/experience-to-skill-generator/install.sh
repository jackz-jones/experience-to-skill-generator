...
show_usage() {
    ...
    echo ""
    echo "可用命令:"
    echo "  experience-to-skill-generator diagnose --input '$EXAMPLES_DIR'"
    echo "  experience-to-skill-generator analyze --input '$EXAMPLES_DIR/blockchain-monitor-session.json'"
    echo "  experience-to-skill-generator generate --input '$EXAMPLES_DIR/blockchain-monitor-session.json' --output-dir './generated_skills'"
    echo "  experience-to-skill-generator config"
    echo ""
    echo "常用环境变量:"
    echo "  ESG_AGENT=auto|openclaw|generic"
